...
export default class Wizard extends Command {
    ...
    public static async execute(
        ...
        console.log('Welcome to the gcr-node wizard! This command will:');
        ...
        if (network == Network.localNetwork) {
            ...
            console.log('');
            console.log(`$ gcr-node start -b ${preset}${assembly ? ` -a ${assembly}` : ''}`);
            return;
        }
        ...
        console.log(`If you don't know what a key is used for, let gcr-node generate a new one for you.`);
        ...
        console.log();
        console.log();
        console.log(`The gcr-node preset file '${customPresetFile}' has been created!!!. Keep this safe!`);
        console.log();
        console.log(`To decrypt the node's private key, run: `);
        console.log();
        console.log(`$ gcr-node decrypt --source ${customPresetFile} --destination plain-custom-preset.yml`);
        console.log();
        console.log('Remember to delete the plain-custom-preset.yml file after used!!!');

        console.log(
            `You can edit this file to further customize it. Read more https://github.com/nemtech/gcr-node/blob/main/docs/presetGuides.md`,
        );
        console.log();
        console.log(`Once you have finished the custom preset customization, You can use the 'start' to run the node in this machine:`);
        console.log();
        console.log(
            `$ gcr-node start -p ${network} -a ${assembly} -c ${customPresetFile} ${
        ...
        console.log();
        console.log(
            `$ gcr-node pack -p ${network} -a ${assembly} -c ${customPresetFile} ${
                target !== defaultParams.target ? `-t ${target}` : ''
            }`,
        );
        console.log();
        ...
        console.log();
        console.log(`$ gcr-node link --useKnownRestGateways -c ${customPresetFile}`);
        console.log();
    }
